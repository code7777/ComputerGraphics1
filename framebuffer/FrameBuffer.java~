...
public class FrameBuffer
{
   ...
   */
   public FrameBuffer(String inputFileName) {
      try {
         ...
         // Create the pixel buffer.
         pixel_buffer = new int[width * height];
   ...
   */
   public void setPixels(int rec_ul_x, int rec_ul_y, int width, int height,
...
/*******************************************************************
   The following code is a inner class of FramBuffer.
********************************************************************/
   ...
   public class Viewport  // inner class (non-static nested class)
   {
      ...
      */
      public Viewport(int vp_ul_x, int vp_ul_y, Viewport sourceVP) {
         int vpWidth  = sourceVP.vp_lr_x - sourceVP.vp_ul_x + 1;
         int vpHeight = sourceVP.vp_lr_y - sourceVP.vp_ul_y + 1;
      ...
      */
      ...
      /**
         Get the upper left hand corner of this {@code Viewport}.

         @return upper left hand corner of this {@code Viewport} rectangle
      */
      ...
      /**
         Get the background {@link Color} of this {@code Viewport}.

         @return background {@link Color} of this {@code Viewport}
      */
      ...
      /**
         Set the background {@link Color} of this {@code Viewport}.

         @param c  background {@link Color} of this {@code Viewport}
      */
...
********************************************************************/
   ...
   */
   public static void main(String[] args) {
      ...
      vp2.vpTest();  // fill the viewport with a test pattern
      ...
      Viewport vp6 = fb4.new Viewport(0, 0, 300, 300); // source
      Viewport vp7 = fb4.new Viewport(900, 300, vp6);
